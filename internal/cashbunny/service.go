...
func (s *Cashbunny) GetAllCurrencies(ctx context.Context) getAllCurrenciesResponse {
	...
	return newGetAllCurrenciesResponse(currencies)
}

func (s *Cashbunny) GetUserPreferences(ctx context.Context, userID uint32) (userPreferencesResponse, error) {
	...
	if !exists {
		return userPreferencesResponse{}, app.NewAppError(app.CodeNotFound, errors.New("user preferences hasn't been created yet"))
	}
	...
	return newUserPreferencesResponse(up), nil
}

func (s *Cashbunny) CreateDefaultUserPreferences(ctx context.Context, userID uint32) (userPreferencesResponse, error) {
