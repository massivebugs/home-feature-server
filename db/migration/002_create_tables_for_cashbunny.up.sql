CREATE TABLE
  IF NOT EXISTS `cashbunny_account_categories` (
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `fk_cb_account_categories_user_id_users_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
  );
...
CREATE TABLE
  IF NOT EXISTS `cashbunny_accounts` (
    ...
    CONSTRAINT `fk_cb_accounts_category_id_cashbunny_account_categories_id` FOREIGN KEY (`category_id`) REFERENCES `cashbunny_account_categories` (`id`)
  );
