    ...
    en: {
      ...
      cashbunny: {
        ...
        account: {
          ...
          form: {
            namePlaceholder: 'e.g. ABC Bank account for savings',
        ...
        transaction: {
          ...
          updatedAt: 'Updated at',
          form: {
            transactedAtPlaceholder: '2006-01-02 15:04:05',
            descriptionPlaceholder: 'Shopping for groceries',
          },
        },
        schedules: 'Schedules',
        accounts: 'Accounts',
    ...
    ja: {
      ...
      cashbunny: {
        ...
        account: {
          ...
          updatedAt: '更新日',
          form: {
            namePlaceholder: 'e.g. ABC 銀行 定期口座',
            descriptionPlaceholder: 'e.g. ここに頑張ってお金貯める！',
          },
        },
        transaction: {
          description: '説明',
          ...
          currency: '通貨',
          sourceAccount: '〜から',
          destinationAccount: '〜に',
          transactedAt: '取引日',
          createdAt: '作成日',
          updatedAt: '更新日',
          form: {
            descriptionPlaceholder: 'お買い物（食材）',
            transactedAtPlaceholder: '2006-01-02 15:04:05',
          },
        },
        schedules: 'スケジュール',
