...
import { TELEBYTE_PROGRAM_ID } from './modules/telebyte/constants'
import TelebyteView from './modules/telebyte/views/TelebyteView.vue'
...
export const getPrograms = (): Program[] => [
  ...
  new Program(TELEBYTE_PROGRAM_ID, '', TelebyteView, {}),
